...
Route::redirect('/yt', '/asd');

Route::fallback(function () {
    return 'Jir kosong';
});

Route::view('/hello', 'hello', ['name' => 'asd']);

Route::get('/hello1', function () {
    return view('hello', ['name' => 'asd']);
});

Route::get('/hello-world', function () {
    return view('hello.world', ['name' => 'asd']);
});
...
Route::get('/conflict/asd', function () {
    return "Conflict asd";
});
...
Route::post('/file/upload', [\App\Http\Controllers\FileController::class, 'upload'])
    ->withoutMiddleware([\App\Http\Controllers\FileController\VerifyCsrfToken::class]);
...
Route::get('/redirect/named', function () {
    // return route('redirect-hello', ['name' => 'asd']);
    // return url()->route('redirect-hello', ['name' => 'asd']);
    return \Illuminate\Support\Facades\URL::route('redirect-hello', ['name' => 'asd']);
});
Route::get('/redirect/action',[\App\Http\Controllers\RedirectController::class, 'redirectAction']);
Route::get('/redirect/away',[\App\Http\Controllers\RedirectController::class, 'redirectAway']);


Route::middleware(['contoh:ASD, 401'])->prefix('/middleware')->group(function () {
